...
namespace WebDT.Controllers
{
    public class GioHangController : Controller
    {
        ...
        [HttpPost]
        public ActionResult MuaNgay(Order entity, long totalPrice, int Product_ID)
        {
            ...
            var product = _db.Products.Find(Product_ID);
            var orderDetail = new Order_Detail();
            ...
            if (product.newprice != null)
            {
                ...
                orderDetail.Amount = product.newprice;
            }
            else
            {
        ...
        [HttpPost]
        public ActionResult ValidateCommand(string product, string totalPrice, string quantity, string name, string CustomerPhone, string adress)
        {
